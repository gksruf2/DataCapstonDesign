...
if __name__ == '__main__':
    ...
    model = FSRCNN.FSRCNN(scale_factor=4, num_channels=1, d=56, s=64, m=4)
    model.to(device)
    #model.load_state_dict(torch.load('/data/gksruf293/repos/FSRCNN/ADAM_300_L2_0.0_model_best_psnr.pt'))
    #teacher_model = IMDN_architecture_fe.IMDN(in_nc=1, nf=64, num_modules=6, out_nc=1, upscale=4)
    #teacher_model.load_state_dict(torch.load('/data/gksruf293/repos/IMDN/save/model_best_psnrn04100.pt'))
    ...
    #criterion = KD_Loss.Loss(["0.5*SA"], device)
